...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#image01', { style: 'fade-down', speed: 1000, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text01', { style: 'fade-right', speed: 1000, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text02', { style: 'fade-up', speed: 1000, intensity: 2, threshold: 3, delay: 250, replay: false });
		onvisible.add('#buttons01', { style: 'fade-left', speed: 1000, intensity: 6, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('#links01', { style: 'slide-left', speed: 625, intensity: 5, threshold: 3, delay: 0, replay: false });
